...
public class UpdateDeleteMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Purchased Item Type");
        ...
        jLabel4.setText("Purchased Item Name");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select *from product_details where Product_ID='"+id+"'");
            while(rs.next())
            {
                checkid = 1;
...
//                jTextField10.setText(rs.getString(10));
            ...
            if(checkid == 0)
            {
                JOptionPane.showMessageDialog(null, "Product ID doesnot Exist");
            }
        }catch(Exception e)
        {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        //Update
        String id = jTextField1.getText();
        String Purchased_Item_Type = jTextField2.getText();
        String Purchased_Item_Name = jTextField3.getText();
        String Purchased_Date = jTextField4.getText();
...
//        String age = jTextField10.getText();
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("update product_details set Item_Type=?,Item_Name=?,Purchased_Date=?, Amount=? where Product_ID=?");
            ps.setString(1, Purchased_Item_Type);
            ps.setString(2, Purchased_Item_Name);
            ps.setString(3, Purchased_Date);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(a==0)
        {
            ...
            try{
                Connection con = ConnectionProvider.getCon();
                Statement st = con.createStatement();
                st.executeUpdate("delete from product_details where Product_ID='"+id+"'");
