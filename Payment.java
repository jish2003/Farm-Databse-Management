...
public class Payment extends javax.swing.JFrame {
    ...
    public void tableDetails()
    {
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from farm_payment where Product_ID='"+id+"'");
            while(rs.next())
            {
                dtm.addRow(new Object[]{rs.getString(2),rs.getString(5)});
            }
        }catch(Exception e)
        {
...
//                jTextField4.setText(rs.getString(4));
            ...
            ResultSet rs1 = st.executeQuery("select * from farm_payment inner join product_details where farm_payment.name = '"+name+"' and farm_payment.Product_ID='"+id+"' and product_details.Product_ID='"+id+"'");
            while(rs1.next())
            {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("insert into farm_payment values(?,?,?,?,?)");
            ps.setString(1, id);
